...
--
This assignment is to be done in LaTeX or Markdown.  Submit both a PDF and the source (.md or .tex) file. Numbered assignments are from [Bayesian Reasoning and Machine Learning by Barber](http://web4.cs.ucl.ac.uk/staff/D.Barber/pmwiki/pmwiki.php?n=Brml.HomePage). Earning 50 points will result in full credit, but it is possible to earn up to 60.
